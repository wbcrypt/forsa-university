...
const STATUS_LABELS: Record<string, string> = {
  ...
  under_review: 'Under Review', more_info_required: 'More Info Required',
  ...
  capital_queue: 'Waiting List', fraud_flagged: 'Fraud — Blacklisted',
  contract_sent: 'Contract Sent', contract_signed: 'Contract Signed',
  university_confirmed: 'University Confirmed', university_paid: 'University Paid',
